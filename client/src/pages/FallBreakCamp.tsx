...
/**
 * Fall Break Camp 2026 - October 12 to 16
 * Design: Navy primary with Crimson Red accents (matches site theme)
 */

export default function FallBreakCamp() {
    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-border shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <Button
            onClick={() => navigate("/fall-break-registration")}
        ...
        <div className="relative h-full container mx-auto px-4 flex items-center">
          <div className="max-w-2xl">
            <div className="inline-block mb-4 px-4 py-2 bg-[#c41e3a]/20 rounded-full border border-[#c41e3a]/30">
              <span className="text-[#c41e3a] font-semibold text-sm tracking-wide">FALL BREAK CAMP 2026</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Fall Break<br />Done Right
            </h1>
            <p className="text-xl text-white/85 mb-8 max-w-xl">
              One action-packed week of martial arts, games, and great memories. October 12 to 16, 2026. Ages 5 and up welcome.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#1a2d5a] mb-4">Fall Break Pricing</h2>
      ...
      <section className="py-20 bg-[#1a2d5a]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/80 text-xl mb-8 max-w-xl mx-auto">
            Fall break is one week. Give your child a week they'll never forget.
          </p>
          <Button
            size="lg"
            onClick={() => navigate("/fall-break-registration")}
