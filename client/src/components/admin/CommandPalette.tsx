...
const PAGES: { label: string; href: string; keywords: string }[] = [
  ...
  { label: "Enrolled Families", href: "/admin/enrolled", keywords: "customers tuition afterschool" },
  { label: "Afterschool Roster", href: "/admin/afterschool-roster", keywords: "pickup school" },
  { label: "Students", href: "/admin/students", keywords: "roster belts" },
  { label: "Orders", href: "/admin/orders", keywords: "proshop payments one-off supply field trip" },
  { label: "Camp Registrations", href: "/admin/camp", keywords: "summer camp waiver" },
  { label: "Invoice Generator", href: "/admin/invoices", keywords: "invoice receipt" },
  { label: "Waivers", href: "/admin/waivers", keywords: "forms signed" },
  { label: "Call Log", href: "/admin/call-log", keywords: "history recordings" },
  ...
  { label: "Studio", href: "/admin/studio", keywords: "media flyer assets" },
];
